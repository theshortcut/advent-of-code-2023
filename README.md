...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `813.5µs` | `2.1ms` |
| [Day 2](./src/bin/02.rs) | `88.9µs` | `91.6µs` |
| [Day 3](./src/bin/03.rs) | `26.7ms` | `16.9ms` |
| [Day 4](./src/bin/04.rs) | `280.9µs` | `294.5µs` |
| [Day 5](./src/bin/05.rs) | `45.3µs` | `1.9s` |
| [Day 6](./src/bin/06.rs) | `2.5µs` | `221.3ms` |
