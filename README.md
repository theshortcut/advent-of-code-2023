...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `842.4µs` | `2.2ms` |
| [Day 2](./src/bin/02.rs) | `89.3µs` | `94.4µs` |
| [Day 3](./src/bin/03.rs) | `24.3ms` | `16.6ms` |
| [Day 4](./src/bin/04.rs) | `295.1µs` | `308.5µs` |
| [Day 5](./src/bin/05.rs) | `46.2µs` | `1.8s` |
| [Day 6](./src/bin/06.rs) | `2.9µs` | `321.1ms` |
| [Day 7](./src/bin/07.rs) | `5.0ms` | `4.7ms` |
| [Day 8](./src/bin/08.rs) | `627.5µs` | `5.1ms` |
| [Day 9](./src/bin/09.rs) | `402.4µs` | `412.8µs` |
| [Day 10](./src/bin/10.rs) | `344.2µs` | `355.2µs` |
| [Day 11](./src/bin/11.rs) | `2.6ms` | `2.6ms` |
| [Day 12](./src/bin/12.rs) | `5.8ms` | `139.9ms` |
| [Day 13](./src/bin/13.rs) | `230.8µs` | `250.2µs` |
| [Day 14](./src/bin/14.rs) | `488.9µs` | `253.7ms` |
