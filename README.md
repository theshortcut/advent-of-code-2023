...
| Day | Part 1 | Part 2 |
| :---: | :---: | :---:  |
| [Day 1](./src/bin/01.rs) | `800.5µs` | `2.1ms` |
| [Day 2](./src/bin/02.rs) | `86.6µs` | `88.9µs` |
| [Day 3](./src/bin/03.rs) | `24.4ms` | `16.4ms` |
| [Day 4](./src/bin/04.rs) | `274.8µs` | `293.6µs` |
| [Day 5](./src/bin/05.rs) | `43.8µs` | `1.8s` |
